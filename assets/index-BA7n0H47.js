      ...
      : u.jsxs(u.Fragment, {
          children: [
            ...
            u.jsx("div", {
              ...
              children: u.jsx("img", {
                src: t || e,
                onClick: () => t === "/assets/richard-heart-gensler-DfcUppmt.webp" && window.open("https://x.com/cz_binance/status/1900114634121601493"),
                className: "h-auto lg:max-h-96 sm:max-h-36 max-h-24",
                style: {cursor:t === "/assets/richard-heart-gensler-DfcUppmt.webp" ? "pointer":"normal"}
              }),
            }),
          ],
        })
...
const mr = () => {
  ...
  (async () => {
    try {
      const l = await y.get(
        "https://api.geckoterminal.com/api/v2/networks/solana/tokens/864YJRb3JAVARC4FNuDtPKFxdEsYRbB39Nwxkzudxy46"
      );
      r(
        (
        ...
        children: [
          ...
          u.jsxs("div", {
            ...
            children: [
              ...
              u.jsx("div", {
                className:
                  "w-[35%] h-[50%] top-[30%] left-[2%] z-20 text-sm md:text-xl text-left text-[rgb(212,175,55)] drop-shadow-[1px_2px_#000] absolute scroll-slide",
                children: u.jsx("div", {
                  className: "w-max px-[1rem] bg-green-900 rounded-xl",
                  children: "0% Tax",
                }),
